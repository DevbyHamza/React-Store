...
const MyForm = () => {
  const [countries] = useState([
    { country: "USA", cities: ["Los Angeles"] },
    { country: "Canada", cities: ["Vancouver"] }
  ]);
  ...
  const handleCountryChange = (e) => {
    ...
    if (selectedCountryData) {
      formik.setFieldValue("city", selectedCountryData.cities[0]); // Set the first city of the selected country
    } else {
      formik.setFieldValue("city", ""); // Reset city value if the selected country is not found
    }
  };
    ...
    <div className="flex items-center justify-center p-24">
      ...
      >
        ...
        <div className="border-2 border-slate-400 ">
          ...
          >
            {formik.values.country && countries.find(country => country.country === formik.values.country).cities.map(city => (
